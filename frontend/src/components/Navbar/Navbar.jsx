  ...
  return (
    <header className="sticky top-0 z-50 h-17.5 border-b border-gray-200/50 bg-white/70 backdrop-blur-xl">
      <div className="mx-auto flex h-full max-w-300 items-center justify-between px-6">
        <Link
          to="/blogs"
          className="flex items-center gap-2 text-2xl font-extrabold text-gray-900 no-underline"
        >
          Mind
        </Link>
        ...
        >
          <span className="h-0.5 w-full rounded bg-gray-900 transition-all"></span>
        ...
        >
          ...
          {username ? (
            ...
            <>
              ...
              <Link to="/login" className={baseNavLinkClass}>
                Sign In
              </Link>

              {/* Reusing 'create-btn' class to make 'Get Started' look like a primary button */}

              <Link to="/signup" className={primaryNavLinkClass}>
                Get Started
              </Link>
            </>
          )}
